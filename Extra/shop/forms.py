...
class BillingShippingForm(forms.Form):
    ...
    """
    shipping_method = forms.ChoiceField(choices=get_shipping_backends_choices(), label=_('Metodo de envio'))
    payment_method = forms.ChoiceField(choices=get_billing_backends_choices(), label=_('Metodo de pago'))

...
from deportmania.models import Talla
...
class CartDetails(ShopTemplateResponseMixin, CartItemDetail):
    ...
    def post(self, *args, **kwargs):
        ...
        talla=self.request.POST['talla']
        tallaconcreta=Talla.objects.filter(id=talla)
        ...
        cart_item = cart_object.add_product(product,tallaconcreta.nombre,product_quantity)
        cart_object.save()
